...
guidef_path = os.path.join(home, 'userdata/')
gui_path = os.path.join(home, 'backups/')
...
gui_save_default = os.path.join(guidef_path, 'gui_settings/')
gui_save_user = os.path.join(gui_path, 'gui_settings_user/')
