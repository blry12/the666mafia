...
ADDONTITLE     = '[COLOR white]-[B]DAREALIST BUILDS WIZARD[/B]-[/COLOR]'
BUILDERNAME    = 'DAREALIST'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'roms', 'My_Builds', 'backupdir', 'script.module.kodi-six', 'script.module.six']
BUILDFILE      = 'https://raw.githubusercontent.com/darealist2021/DAREALIST-BUILDS/main/darealistbuilds.txt'
UPDATECHECK    = 0
APKFILE        = 'http://'
...
WIZTITLE = 'DAREALIST BUILDS WIZARD'
...
WIZARDFILE     = 'https://github.com/darealist2021/DAREALIST-BUILDS/raw/main/plugin.program.darealist.zip'
#########################################################
...
NOTIFICATION   = 'https://raw.githubusercontent.com/darealist2021/DAREALIST-BUILDS/main/darealistnotify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE     = 'Text'
# Font size of header
FONTHEADER     = 'Font13'
HEADERMESSAGE  = 'Welcome to DAREALIST BUILDS WIZARD'
