...
BUILDFILE      = 'https://the666mafia.com/repo/builds/txt/setitoffbuilds.txt'
UPDATECHECK    = 0
APKFILE        = 'https://'
...
WIZARDFILE     = 'https://the666mafia.com/repo/builds/txt/plugin.program.setitoffwiz.zip'
#########################################################
...
NOTIFICATION   = 'https://the666mafia.com/repo/builds/txt/setitoffnotify.txt'
